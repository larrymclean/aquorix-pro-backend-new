   ...
   - [ ] Verify the existing `postgres` schema in Supabase.
   ...
   - [ ] Execute schema updates via the `pg` client or Supabase.

   ### Step 4: Implement CRUD Operations
   - [ ] Add API endpoints in `server.js` for basic CRUD operations.
   ...
   - [ ] Write unit tests for database operations using a testing framework (e.g., Jest).
     - Test connection success and failure cases.
     - Test CRUD operations with mock data.
   - [ ] Validate data integrity and performance with sample queries.
   - [ ] Ensure environment variables are not exposed in version control.
   ...
   - Steps 3–5: Target completion by 2025-07-10.